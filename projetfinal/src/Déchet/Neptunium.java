 ...
 */
public class Neptunium extends Déchets implements Serializable {
    ...
    public void Chargement(){
        try {
            ...
            masseVolumique = Integer.parseInt(root.getChildNodes().item(3).getChildNodes().item(1).getChildNodes().item(0).getFirstChild().getNodeValue());
            recyclabe = Integer.parseInt(root.getChildNodes().item(3).getChildNodes().item(1).getChildNodes().item(1).getFirstChild().getNodeValue());
